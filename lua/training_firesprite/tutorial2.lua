...
taskSuccess = {
  function () return not gomgr.getbyoid(1652).canbreaknext end,
  
  function () 
    return tornadomgr.firstactivetornado:isgrabbingsprites()
	        or tornadomgr.secondactivetornado:isgrabbingsprites()
  end,

  function () 
    return tornadomgr.firstactivetornado.firespritescollected >= totalspritecount
	        or tornadomgr.secondactivetornado.firespritescollected >= totalspritecount
  end
}
taskFail = {
  function () return false end,
  function () if (tornadomgr.firstactivetornado.firespritescollected >= totalspritecount) then return true else return false end end,
  function () return (tornadomgr.firstactivetornado.firespritescollected >= totalspritecount and tornadomgr.isactionmatched(4)) end
}
